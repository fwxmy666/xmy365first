...
<div class="mws-panel grid_8">
    ...
    <div class="mws-panel-body no-padding">
    	...
    	<form action="/admin/friends" method='post' class="mws-form" enctype='multipart/form-data'>
			...
			<div class="mws-form-row">
                    ...
                    <div class="mws-form-item" style="display:inline">
                        <input type="text" name='http' class="small">
			...
			<div class="mws-form-row">
				...
				<div class="mws-form-item">
					<input type="file" name='url' multiple readonly="readonly" style="width: 30%;" class="fileinput-preview" placeholder="No file selected...">
				</div>
			</div>
